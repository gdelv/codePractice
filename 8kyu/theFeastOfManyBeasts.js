...
// console.log('blueheron'.length)
// console.log('blue heron'.length)


const feast = (strA,strB) => {
    if( (strA[0] && strA[strA.length-1]) === (strB[0] && strB[strB.length-1]) ) {
        return true
    } else  {
        return false
    }
...
//Refactored solution to pass all tests
const feast = (strA,strB) => {
    if( (strA[0]) === (strB[0]) ) {
